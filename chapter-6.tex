...
\addplot[black,solid] table[x index=0,y index=1]{figures/grey-density.dat};
\addplot[black,dashed] table[x index=0,y index=2]{figures/grey-density.dat};
\addplot[black,dotted] table[x index=0,y index=0]{figures/grey-density.dat};
\end{axis}
\end{tikzpicture}
